...
def build_xview_dataset(image_set, args):
    ...
    PATHS = {
        "train": (os.path.join(root), os.path.join('/Users/mendeza/data/xview/train_sliced_no_neg/',"/tmp/train_300_02.json")),
        "val": (os.path.join(root), os.path.join('/Users/mendeza/data/xview/val_sliced_no_neg/',"/tmp/val_300_02.json")),
    }
    print("PATHS: ",PATHS)
    # ~/data/coco_dataset/annotations/
    # For testing locally
